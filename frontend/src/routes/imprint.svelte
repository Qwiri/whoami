<div id="content">
	...
	<p>Luca Hackl</p>
	<br />
	<p>Am Alten Güterbahnhof 12</p>
	<p>76646 Bruchsal</p>
	<br />
	<p><strong>Kontakt</strong></p>
	<p>Email: steckplatz.vier09@icloud.com</p>
	<br />
	...
	<p>
		...
		haben. Deshalb kann ich für diese fremden Inhalte auch keine Gewähr übernehmen. Für die Inhalte
	...
	<p>
		Die Betreiber dieser Seiten nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Ich behandle
		Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen
		Datenschutzvorschriften sowie dieser Datenschutzerklärung. Die Nutzung meiner Webseite ist in
		der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten
		personenbezogene Daten (beispielsweise Name, Anschrift oder E-Mail-Adressen) erhoben werden,
	...
	<p>
		In meinen log files werden nur die lokale Zeit der Anfrage, und der Anfragestatus gespeichert.
	...
	<br /><br /><br /> <button><a href="/" class="text-white">Go back</a></button> <br /><br />
</div>
